...
public class HelloController {
	...
	/*
	 * @RequestMapping("/mensagemDoServidor2") public ModelAndView
	 * mensagemDoServidorV2() { return new ModelAndView("mensagemDoServidor",
	...
	public String receberMensagem2(Model model,
			@RequestParam(value = "mensagem", required = false, defaultValue = "Mensagem padrao") String msg) {
		model.addAttribute("mensagem", msg);
		return "mensagemDoServidor";
	}
